...
<?php startblock('principal') ?>
    <div class="main">
        ...
        </br></br>NeverForget es uno de nuestros proyectos mas ambiciosos que pretende revolucionar el concepto actual de visita de interes aumentado.
        NeverForget le da al usuario la posibilidad de hacer un recorrido por la ciudad de Barcelona visitando los sitios mas relevantes durante la Guerra Civil Española.
        Toda la experiéncia se basa en sumir al usuario en una historia adaptada al contexto historico de la epoca.
        </br></br>El objetivo es dar a conocer la historia des de un punto de vista turistico, lúdico y cultural. Para ello hemos creado un recorrido lineal por la ciudad con cinco paradas obligatorias donde el usuario deberá resolver un enigma en cada una de ellas.
        Al final del recorrido el usuario 
        </p>
        </br>
        <h3>Members</h3>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer justify-content-center">
                                <ul>
                                    ...
                                    <li><a href="https://www.linkedin.com/in/esther-galdeano/" target="_blank"><i class="fa fa-linkedin iconAbout"></i></a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer justify-content-center">
                                <ul>
                                    ...
                                    <li><a href="https://www.linkedin.com/in/jordi-pe%C3%B1a-811240177/" target="_blank"><i class="fa fa-linkedin iconAbout"></i></a></li>
                                    <li><a href="https://www.instagram.com/jordi_xt/" target="_blank"><i class="fa fa-instagram iconAbout"></i></a></li>    
                                </ul> 
                            </div>
                        </div>
                    </div>
