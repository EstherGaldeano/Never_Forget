...
<div class="modal fade" id="LoginModal" tabindex="-1" role="dialog" aria-labelledby="LoginModalLabel" aria-hidden="true">
        ...
        <div id="texto" class="texto text-center">
            ...
            <?php if(isset($_SESSION['userLoged'])){?>
                <button type="button" class="btn-lg btn-danger regular-button mr-5 button"  data-toggle="modal" data-target="#LoginModal" disabled="true">LOG IN</button>
            <?php }else{?>
                <button type="button" class="btn-lg btn-danger regular-button mr-5 button"  data-toggle="modal" data-target="#LoginModal">LOG IN</button>
            <?php } ?>
            <button type="button" class="btn-lg btn-danger regular-button mr-5 button"  data-toggle="modal" data-target="#RegistreModal">REGISTER</button>
        </div> 
