...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-12-2018 a las 11:40:40
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `progress`, `role`) VALUES
(1, 'jo', 'jo@jo', 'jo', 0, 0),
(10, 'jor', 'jod@jod', 'jod', 0, 0),
(11, 'ell', 'ell@ell', 'ell', 0, 0);
